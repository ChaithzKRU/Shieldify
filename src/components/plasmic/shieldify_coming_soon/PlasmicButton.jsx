...
import sty from "./PlasmicButton.module.css"; // plasmic-import: JSW09KUny-Q/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: _6_zLEVNMV6/icon
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: Ae3Hja1Khyy/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__q8KX1)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Icon2Icon
                className={classNames(projectcss.all, sty.svg__egwHw)}
                role={"img"}
              />
            ),

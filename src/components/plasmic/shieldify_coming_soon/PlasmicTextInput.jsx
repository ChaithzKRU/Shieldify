...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: tUnhHDXVjmN/css
import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: HsUSF2pni7F/icon
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: _6_zLEVNMV6/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <SearchsvgIcon
                className={classNames(projectcss.all, sty.svg__uFPhy)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__aSqAp)}
                role={"img"}
              />
            ),
